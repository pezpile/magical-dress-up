...
import Character from './CharacterPNG.jsx';
...
export default function App() {
  ...
  function handleOutfitChange(patch) {
    setOutfit(prev => ({ ...prev, ...patch }));
  }
      ...
      <main className="main-content">
        ...
        <div className="color-panel">
          ...
          <div className="panel-card tips-card">
            ...
            <p className="tip">Dresses replace tops + bottoms.</p>
          </div>
        </div>
